...
locals {
  debian_11_iso_url      = "https://cdimage.debian.org/debian-cd/current/amd64/iso-cd/debian-11.7.0-amd64-netinst.iso"
  debian_11_iso_checksum = "file:https://cdimage.debian.org/debian-cd/current/amd64/iso-cd/SHA256SUMS"
...
source "bhyve" "debian-11-smartos-x86_64" {
  ...
  vm_name            = "debian-11-smartos-${formatdate("YYYYMMDD", timestamp())}.x86_64.raw"
...
source "qemu" "debian-11-smartos-uefi-x86_64" {
  iso_url            = local.debian_11_iso_url
  iso_checksum       = local.debian_11_iso_checksum
  shutdown_command   = var.root_shutdown_command
  accelerator        = "kvm"
  ...
  net_device         = "virtio-net"
  qemu_binary        = var.qemu_binary
  vm_name            = "debian-11-smartos-uefi-${formatdate("YYYYMMDD", timestamp())}.x86_64.raw"
  boot_wait          = "10s"
  boot_command       = local.debian_11_boot_command
}
...
build {
  sources = [
    "bhyve.debian-11-smartos-x86_64",
    "qemu.debian-11-smartos-x86_64",
    "qemu.debian-11-smartos-uefi-x86_64"
  ]
